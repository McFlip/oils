...
test('create a new product', async () => {
  ...
  fireEvent.change(getByTestId('wholesale'), { target: { value: 0.99 } })
  fireEvent.change(getByTestId('retail'), { target: { value: 9.99 } })
  fireEvent.change(getByTestId('pv'), { target: { value: 1 } })
